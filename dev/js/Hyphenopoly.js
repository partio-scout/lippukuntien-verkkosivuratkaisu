...
(function (w, o) {
  ...
  var event = function (H) {
    var knownEvents = new Map([["afterElementHyphenation", []], ["beforeElementHyphenation", []], ["engineReady", []], ["error", [function (e) {
      if (e.runDefault) {
        w.console.warn(e);
      }
    ...
    if (H.handleEvent) {
      var userEvents = new Map(o.entries(H.handleEvent));
      knownEvents.forEach(function (eventFuncs, eventName) {
    ...
    return {
      "fire": function fire(eventName, eventData) {
        ...
        knownEvents.get(eventName).forEach(function (eventFn) {
          eventFn(eventData);
        });
      }
    };
  ...
  (function (H) {
    ...
    function createMapWithDefaults(defaultsMap) {
      ...
      return new Proxy(defaultsMap, {
        ...
        "ownKeys": function ownKeys() {
          return _toConsumableArray(new Set([].concat(_toConsumableArray(defaultsMap.keys()), _toConsumableArray(userMap.keys()))));
        }
      });
    }

    var settings = createMapWithDefaults(new Map([["defaultLanguage", "en-us"], ["dontHyphenate", function () {
      ...
      return createMapWithDefaults(new Map(list.split(",").map(function (val) {
        return [val, true];
      })));
    ...
    o.entries(H.s).forEach(function (_ref) {
      ...
      switch (key) {
        case "selectors":
          ...
          o.entries(value).forEach(function (_ref3) {
            var _ref4 = _slicedToArray(_ref3, 2),
                sel = _ref4[0],
                selSettings = _ref4[1];

            var selectorSettings = createMapWithDefaults(new Map([["compound", "hyphen"], ["hyphen", SOFTHYPHEN], ["leftmin", 0], ["leftminPerLang", 0], ["minWordLength", 6], ["mixedCase", true], ["orphanControl", 1], ["rightmin", 0], ["rightminPerLang", 0]]));
            o.entries(selSettings).forEach(function (_ref5) {
              var _ref6 = _slicedToArray(_ref5, 2),
                  selSetting = _ref6[0],
                  setVal = _ref6[1];

              if (_typeof(setVal) === "object") {
        ...
        case "dontHyphenate":
        case "exceptions":
          o.entries(value).forEach(function (_ref7) {
        ...
        case "substitute":
          o.entries(value).forEach(function (_ref9) {
  ...
  (function (H) {
    ...
    function getLang(el) {
      var parentLang = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    ...
    function collectElements() {
      ...
      var elements = makeElementCollection();

      var dontHyphenateSelector = function () {
        var s = "." + C.dontHyphenateClass;
        o.getOwnPropertyNames(C.dontHyphenate).forEach(function (tag) {
      ...
      function processElements(el, pLang, sel) {
        ...
        var eLang = getLang(el, pLang);
        var langDef = H.cf.langs.get(eLang);
        ...
        if (langDef === "H9Y") {
          ...
          event.fire("error", Error("Element with '".concat(eLang, "' found, but '").concat(eLang, ".wasm' not loaded. Check language tags!")));
        }
      ...
      if (parent === null) {
        if (C.processShadows) {
          w.document.querySelectorAll("*").forEach(function (m) {
            if (m.shadowRoot) {
    ...
    function createWordHyphenator(lo, lang, sel) {
      ...
      function hyphenateCompound(word) {
        ...
        if (selSettings.compound === "auto" || selSettings.compound === "all") {
          ...
          parts = word.split("-").map(function (p) {
    ...
    function hyphenate(lang, sel, entity) {
      ...
      var selSettings = C.get(sel);
      var minWordLength = selSettings.minWordLength;
      /*
       * Transpiled RegExp of
       * /[${alphabet}\p{Mn}Subset\p{Letter}\00AD-]{${minwordlength},}/gui
       */

      var reWord = RegExp("[".concat(lo.alphabet, "a-z\u0300-\u036F\u0483-\u0487\xDF-\xF6\xF8-\xFE\u0101\u0103\u0105\u0107\u0109\u010D\u010F\u0111\u0113\u0117\u0119\u011B\u011D\u011F\u0123\u0125\u012B\u012F\u0131\u0135\u0137\u013C\u013E\u0142\u0144\u0146\u0148\u014D\u0151\u0153\u0155\u0159\u015B\u015D\u015F\u0161\u0165\u016B\u016D\u016F\u0171\u0173\u017A\u017C\u017E\u017F\u01CE\u01D0\u01D2\u01D4\u01D6\u01D8\u01DA\u01DC\u0219\u021B\u02BC\u0390\u03AC-\u03CE\u03D0\u03E3\u03E5\u03E7\u03E9\u03EB\u03ED\u03EF\u03F2\u0430-\u044F\u0451-\u045C\u045E\u045F\u0491\u04AF\u04E9\u0561-\u0585\u0587\u0905-\u090C\u090F\u0910\u0913-\u0928\u092A-\u0930\u0932\u0933\u0935-\u0939\u093D\u0960\u0961\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A85-\u0A8B\u0A8F\u0A90\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AE0\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B60\u0B61\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB5\u0BB7-\u0BB9\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C33\u0C35-\u0C39\u0C60\u0C61\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0D05-\u0D0C\u0D0E-\u0D10\u0D12-\u0D28\u0D2A-\u0D39\u0D60\u0D61\u0D7A-\u0D7F\u0E01-\u0E2E\u0E30\u0E32\u0E33\u0E40-\u0E45\u10D0-\u10F0\u1200-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u1E0D\u1E37\u1E41\u1E43\u1E45\u1E47\u1E6D\u1F00-\u1F07\u1F10-\u1F15\u1F20-\u1F27\u1F30-\u1F37\u1F40-\u1F45\u1F50-\u1F57\u1F60-\u1F67\u1F70-\u1F7D\u1F80-\u1F87\u1F90-\u1F97\u1FA0-\u1FA7\u1FB2-\u1FB4\u1FB6\u1FB7\u1FC2-\u1FC4\u1FC6\u1FC7\u1FD2\u1FD3\u1FD6\u1FD7\u1FE2-\u1FE7\u1FF2-\u1FF4\u1FF6\u1FF7\u2C81\u2C83\u2C85\u2C87\u2C89\u2C8D\u2C8F\u2C91\u2C93\u2C95\u2C97\u2C99\u2C9B\u2C9D\u2C9F\u2CA1\u2CA3\u2CA5\u2CA7\u2CA9\u2CAB\u2CAD\u2CAF\u2CB1\u2CC9\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\xAD\u200B-\u200D-]{").concat(minWordLength, ",}"), "gui");
      /**
      ...
      function hyphenateText(text) {
        ...
        var tn = text.replace(reWord, createWordHyphenator(lo, lang, sel));
    ...
    function createStringHyphenator(lang) {
      return function (entity) {
        var sel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ".hyphenate";
    ...
    function createDOMHyphenator() {
      return function (entity) {
        var sel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ".hyphenate";
        collectElements(entity, sel).list.forEach(function (els, l) {
    ...
    H.unhyphenate = function () {
      H.res.els.list.forEach(function (els) {
        els.forEach(function (elo) {
    ...
    function hyphenateLangElements(lang, elements) {
      var elArr = elements.list.get(lang);

      if (elArr) {
        elArr.forEach(function (elo) {
          hyphenate(lang, elo.selector, elo.element);
        });
      } else {
        event.fire("error", Error("Engine for language '".concat(lang, "' loaded, but no elements found.")));
      }
    ...
    function createExceptionMap(lang) {
      ...
      return new Map(exc.split(", ").map(function (e) {
    ...
    function prepareLanguagesObj(lang, hyphenateFunction, alphabet, patternLeftmin, patternRightmin) {
      ...
      H.languages.set(lang, {
        ...
        "ready": true,
        "reNotAlphabet": RegExp("[^".concat(alphabet, "]"), "i")
      });
    ...
    function encloseHyphenateFunction(baseData, hyphenateFunc) {
      var wordStore = new Uint16Array(baseData.buf, baseData.wo, 64);
      return function (word, hyphencc, leftmin, rightmin) {
        wordStore.set([95].concat(_toConsumableArray(_toConsumableArray(word).map(function (c) {
          return c.charCodeAt(0);
        })), [95, 0]));
        var len = hyphenateFunc(leftmin, rightmin, hyphencc);
    ...
    function instantiateWasmEngine(heProm, lang) {
      ...
      function registerSubstitutions(alphalen, exp) {
        if (C.substitute.has(lang)) {
          var subst = C.substitute.get(lang);
          subst.forEach(function (substituer, substituted) {
            var substitutedU = substituted.toUpperCase();
            var substitutedUcc = substitutedU === substituted ? 0 : substitutedU.charCodeAt(0);
      ...
      heProm.w.then(function (response) {
        if (response.ok) {
          var r2 = response;
        ...
        return Promise.reject(Error("File ".concat(lang, ".wasm can't be loaded from ").concat(H.paths.patterndir)));
      }).then(handleWasm, function (e) {
        event.fire("error", e);
        H.res.els.rem(lang);
      });
    }
    ...
    H.res.DOM.then(function () {
      ...
      H.res.els = elements;
      elements.list.forEach(function (ignore, lang) {
        if (H.languages && H.languages.has(lang) && H.languages.get(lang).ready) {
          hyphenateLangElements(lang, elements);
        }
      });
    });
    H.res.he.forEach(function (heProm, lang) {
      instantiateWasmEngine(heProm, lang);
    });
    Promise.all( // Make sure all lang specific hyphenators and DOM are ready
    _toConsumableArray(H.hy6ors.entries()).reduce(function (accumulator, value) {
      if (value[0] !== "HTML") {
        return accumulator.concat(value[1]);
      }

      return accumulator;
    }, []).concat(H.res.DOM)).then(function () {
